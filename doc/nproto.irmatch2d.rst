...
.. raw:: html
  ...
  etc.
  If <I>alignment</I> = "<TT>file</TT>", then <B>coords</B> is the text file listing
  ...
  If <I>alignment</I> = "<TT>coords</TT>", IRMATCH2D accumulates the relative shifts
  ...
  "<TT>row</TT>" and <I>raster</I> = "<TT>no</TT>", then the matching would proceed along
