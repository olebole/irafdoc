...
.. raw:: html
  ...
  for efficiency curves at different orders.  The parameter <tt>"effN"</tt> (or <tt>"xeffN"</tt>
  ...
  <tt>"apmagdisp"</tt> and <tt>"apxmagdisp"</tt>.  These define magnifications of the aperture
